...
async def startupmessage():
    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await jmthon.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/4ea4a4945d42ae76d1f4e.jpg",
                caption="⌔︙ **بــوت ياقوت يـعـمـل  بـنـجـاح**  ✅ ",
                buttons=[(Button.url("مطور السورس", "https://t.me/PROTECTmnbot"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    try:
        if msg_details:
            ...
            text = message.text + "\n\n**⌔︙ اهلا وسهلا لقد قمت باعاده تشغيل بـوت ياقوت تمت بنجاح**"
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "مجموعه بوت ياقوت الخاص بك", jmthon, Config.TG_BOT_USERNAME, descript
        )
